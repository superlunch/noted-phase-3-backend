...
Project.create(id: 1, title: "Thoughts on...")
Project.create(id: 2, title: "Ephemera, etc.")
Project.create(id: 3, title: "for Tuesday")
Project.create(id: 4, title: "SECRETS")


puts "Seeding notes..."

Note.create(id: 1, title: "DO NOT OPEN", body: "Pellentesque vel porta enim. Etiam dignissim vehicula ligula id maximus. Pellentesque massa nunc, feugiat sed semper non, feugiat in ex. Curabitur vel pretium ante. Morbi auctor pretium gravida. Curabitur quis lacus neque. Curabitur rutrum, lacus eu lacinia tempus, nibh dui auctor quam, eleifend placerat orci arcu sagittis nunc. Donec tristique tristique erat at sagittis.", project_id: 4, user_id: 2)
Note.create(id: 2, title: "idea???", body: "Maecenas vel odio sagittis, porttitor velit id, lobortis felis.", project_id: 3, user_id: 1)
Note.create(id: 3, title: "Don't forget:", body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ac nibh convallis neque accumsan pharetra in vitae lectus. Mauris sapien purus, pretium quis mattis vitae, interdum ac dolor. Nunc eget leo sed libero varius imperdiet.", project_id: 1, user_id: 4)
Note.create(id: 4, title: "quotes i love", body: "Cras rhoncus, ex eget egestas vestibulum, purus tellus blandit elit, et aliquam est libero in tellus. Nunc tristique porta eleifend. Integer feugiat vehicula eleifend. Duis eu diam quis mi pellentesque volutpat eget nec tellus. Pellentesque laoreet nisi urna, ut molestie mauris dapibus sit amet. Nulla venenatis neque quis augue vulputate cursus.", project_id: 2, user_id: 3)
Note.create(id: 5, title: "shhhhhh", body: "Ut luctus, risus sit amet vulputate condimentum, magna felis lobortis lacus, vitae iaculis nisl arcu sed enim. Donec congue facilisis nibh, vitae iaculis dui vulputate at.", project_id: 4, user_id: 2)
